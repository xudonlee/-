  ...
  <body>
  		...
  		<form action="book" method="post">
			<input type="hidden" name="_method" value="put">  		
  			图书编码:<input type="text" name="bookId" value="${n.bookId }" readonly="readonly"/><p>
  			...
  			出版日期:<input type="text" name="bookDay" value='<fmt:formatDate value="${n.bookDay }" pattern='yyyy-MM-dd'/>' onclick="WdatePicker()" class="Wdate" readonly="readonly"/><p>
  			图书类型:<input type="text" name="typeName" value="${n.typeName}"><p>
